...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-C_OSk_pu.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-0n3q3tjb.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DJTwReLS.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-Byc3FHMm.mjs'));
